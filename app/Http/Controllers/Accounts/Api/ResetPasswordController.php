...
class ResetPasswordController extends Controller
{
    ...
    public function forget(ForgetPasswordRequest $request)
    {
        ...
        if (env('APP_ENV') == 'local') {
            ...
            Storage::disk('public')->append(
                'verification.txt',
                "Your verification code  is {$resetPasswordCode->code} generated at " . now()->toDateTimeString(),
                "\n"
            );
        }
    ...
    public function code(ResetPasswordCodeRequest $request)
    {
        ...
        if (env('APP_ENV') == 'local') {
            ...
            Storage::disk('public')->append(
                'verification.txt',
                "Your verification reset_token  is {$token} generated at " . now()->toDateTimeString(),
                "\n"
            );
        }
